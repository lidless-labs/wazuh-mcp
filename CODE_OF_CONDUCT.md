...
The Code of Conduct applies to all project spaces: GitHub issues and pull requests on this repo, project-related discussions on chat surfaces, and any in-person events where someone is representing the project.
...
The maintainer is also the recipient of security reports - see [SECURITY.md](SECURITY.md). Please tag the subject line so it is easy to route (e.g. "CoC report" vs "security report").
